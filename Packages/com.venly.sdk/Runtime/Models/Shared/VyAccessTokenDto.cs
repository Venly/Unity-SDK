...
namespace VenlySDK.Models.Shared
{
    public class VyAccessTokenDto
    {
        ...
        [JsonIgnore] public VyJwtInfo JwtInfo { get; internal set; }
        [JsonIgnore] public eVyEnvironment Environment => JwtInfo?.Environment ?? throw new ArgumentException("JWT Info not set...");
