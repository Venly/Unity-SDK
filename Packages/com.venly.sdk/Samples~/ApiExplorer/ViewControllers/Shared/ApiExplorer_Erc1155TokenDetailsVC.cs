...
public class ApiExplorer_Erc1155TokenDetailsVC : SampleViewBase<eApiExplorerViewId>
{
    ...
    private void BuildAttributes()
    {
        ...
        _lstAnimationUrls.ToggleDisplay(_tokenMetadata.Attributes.Length > 0);
    ...
    private void OnClick_Transfer()
    {
        ...
        ViewManager.SetViewBlackboardData(eApiExplorerViewId.WalletApi_TransferNft, ApiExplorer_TransferNftVC.DATAKEY_WALLET, wallet);
        ViewManager.SetViewBlackboardData(eApiExplorerViewId.WalletApi_TransferNft, ApiExplorer_TransferNftVC.DATAKEY_TOKEN, _token);
