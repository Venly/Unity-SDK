...
{
    public class VyAccessToken
    {
        [JsonProperty("access_token")] public string Token { get; private set; }
        [JsonProperty("expires_in")][JsonConverter(typeof(ExpireConverter))] public DateTime TokenExpire { get; private set; }
        [JsonProperty("refresh_token")] public string RefreshToken { get; private set; }
        [JsonProperty("refresh_expires_in")][JsonConverter(typeof(ExpireConverter))] public DateTime RefreshTokenExpire { get; private set; }
