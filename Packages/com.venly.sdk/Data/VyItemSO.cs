...
namespace Venly.Data
{
    ...
    public abstract class VyItemSO : ScriptableObject
    {
        ...
        [VyItemField(eVyItemTrait.LiveReadOnly)] public bool Confirmed;
        [VyItemField(eVyItemTrait.LiveReadOnly)] public int Id;
        [VyItemField(eVyItemTrait.LiveReadOnly)] public string TransactionHash;
