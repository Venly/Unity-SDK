...
namespace Venly.Data
{
    public class VyTokenTypeSO : VyItemSO
    {
        ...
        [VyItemField(eVyItemTrait.LiveReadOnly)] public string ImageThumbnail;
        [VyItemField(eVyItemTrait.LiveReadOnly)] public string ImagePreview;
        [VyItemField(eVyItemTrait.LiveReadOnly)] public long CurrentSupply;
        ...
        public VyTokenType ToModel()
        {
            return new VyTokenType
            {
                Name = Name,
...
#if UNITY_EDITOR
        public void UpdateLiveModel(VyTokenType model)
        {
